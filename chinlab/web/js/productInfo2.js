function initFileInput2(ctrlName, uploadUrl, initurl) {
    ...
    control2.fileinput({
        ...
        initialPreviewConfig: [
           {width: "200px", key: 1, showDelete: false},
        ],
    });
}
...
function initFileInput1(ctrlName, uploadUrl, initurl) {
	...
	$.each(initurl, function(k, v){
		preImage[preImage.length] =v;// '<img src="' + v + '" width="200" height="200" alt="图标"/>'
		preViewConf[preImage.length-1] =  {width: "200px", key: preImage.length, showDelete: false};
	});
    control1.fileinput({
        language: 'zh', //设置语言
        uploadUrl: uploadUrl, //上传的地址
	    ...
	    $(document).on("click", "#save",function(){
	    	...
	    	$.ajax({
	    		...
	    		data:{
	    			...
	    			"goods_service":arr,
	    			"is_onsalt":is_onsalt,
	    			"goods_big_image": img3,
					"goods_small_image": img2,
