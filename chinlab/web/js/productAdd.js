...
$(document).ready(function(){
    ...
    //上传图片
    initFileInput1("tcicon", "/shop_goodsimage.php?type=3", "");
    ...
    $('#tcicon').on('filesuccessremove', function (event, id) {
	    ...
	    initFileInput2("tcicon2", "/shop_goodsimage.php?type=1", "");
	    ...
	    initFileInput3("tcicon3", "/shop_goodsimage.php?type=2", "");
    ...
    $(document).on("click", "#save", function () {
		...
		$.ajax({
			...
			data: {
				...
				"goods_image": commit_goods_image_info,
			},
			async: true,
