...
$(document).ready(function(){
			...
			//上传图片
 			initFileInput1("tcicon", "/cms_uploadimage.php?type=1", "");
	        ...
	        //文字验证
	        $("#articleTit").blur(function(){
	        	var length = $(this).val().length
	        	//console.log(length)
	        	if(length<5){
	        		$("#articleTit_err").html("您输入的标题少于5个字");
	        	}else{
	        		$("#articleTit_err").html("");
	        	}
	        })
	    	...
	    	$("#saveedit").click(function(){
	    		...
	    		$.ajax({
	    			...
	    			data:{
						...
						"list_image" : JSON.stringify(commit_goods_image_info),
