            ...
            "columnDefs": [
                {
                    ...
                    "render": function (data, type, full) {
						...
						if (info_role == 1) {
							...
							if (data.status == 0) {
								return '<a class="redact" data-id="' + data.material_id + '" data-type="'+ data.channel_no +'" href="javascript:void(0)">编辑</a>&nbsp;&nbsp;<a class="preview" data-id="' + data.material_id + '" data-url="' + data.news_url + '" href="javascript:void(0)">预览</a>&nbsp;&nbsp;<a class="submit_check" data-id="' + data.material_id + '" href="javascript:void(0)">提交审核</a>&nbsp;&nbsp;<a class="delete" data-id="' + data.material_id + '" href="javascript:void(0)">删除</a>';
							} else if (data.status == 1) {
								return '<a class="redact" data-id="' + data.material_id + '" data-type="'+ data.channel_no +'" href="javascript:void(0)">编辑</a>&nbsp;&nbsp;<a class="preview" data-id="' + data.material_id + '" data-url="' + data.news_url + '" href="javascript:void(0)">预览</a>&nbsp;&nbsp;<a class="check" data-id="' + data.material_id + '" data-type="'+ data.channel_no +'" href="javascript:void(0)">审核</a>&nbsp;&nbsp;<a class="delete" data-id="' + data.material_id + '" href="javascript:void(0)">删除</a>';
							} else if (data.status == 2) {
								return '<a class="preview" data-id="' + data.material_id + '" data-url="' + data.news_url + '" href="javascript:void(0)">预览</a>&nbsp;&nbsp;<a class="check" data-type="'+ data.channel_no +'" data-id="' + data.material_id + '"  href="javascript:void(0)">审核</a>&nbsp;&nbsp;<a class="delete" data-id="' + data.material_id + '" href="javascript:void(0)">删除</a>';
							} else if (data.status == 3) {
							...
							if (data.status == 0) {
								...
								return '<a class="preview" data-id="' + data.material_id + '" data-url="' + data.news_url + '" href="javascript:void(0)">预览</a>&nbsp;&nbsp;<a class="check" data-type="'+ data.channel_no +'" data-id="' + data.material_id + '" href="javascript:void(0)">审核</a>';
							} else if (data.status == 2) {
								return '<a class="preview" data-id="' + data.material_id + '" data-url="' + data.news_url + '" href="javascript:void(0)">预览</a>&nbsp;&nbsp;<a class="check" data-type="'+ data.channel_no +'" data-id="' + data.material_id + '"  href="javascript:void(0)">审核</a>';
							} else if (data.status == 3) {
								return '<a class="preview" data-id="' + data.material_id + '" data-url="' + data.news_url + '" href="javascript:void(0)">预览</a>';
							...
							if (data.status == 0) {
								...
								return '<a class="redact" data-id="' + data.material_id + '" data-type="'+ data.channel_no +'" href="javascript:void(0)">编辑</a>&nbsp;&nbsp;<a class="preview" data-id="' + data.material_id + '" data-url="' + data.news_url + '" href="javascript:void(0)">预览</a>&nbsp;&nbsp;<a class="delete" data-id="' + data.material_id + '" href="javascript:void(0)">删除</a>';
							} else if (data.status == 2) {
...
//			var trid = $(this).attr("trid");
		...
		layerindex = layer.open({
			...
			content: "/cms/advertisementadd.php",
			end: function() {
				dataTable1.draw();
				$(document.body).css({
					"overflow-x": "auto",
	...
	var layerredact = "";
 	$(document).on("click", ".redact",function() {
		...
		var redact_url = "";
		if(adtype==2){
			redact_url = "/cms/adredactstart.php?material_id=" + trid
		}else{
			redact_url = "/cms/adredactcontent.php?material_id=" + trid
		}
		$(document.body).css({
			"overflow-x": "hidden",
			"overflow-y": "hidden"
	...
	var layerredact = "";
 	$(document).on("click", ".check",function() {
		...
		var check_url = "";
		if(adtype==2){
			check_url = "/cms/adcheckstart.php?material_id=" + trid
		}else{
			check_url = "/cms/adcheckcontent.php?material_id=" + trid
		}
		$(document.body).css({
			"overflow-x": "hidden",
			"overflow-y": "hidden"
