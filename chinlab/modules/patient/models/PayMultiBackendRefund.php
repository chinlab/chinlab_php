...
/**
 * This is the model class for table "pay_multi_backend_refund".
 *
 ...
 */
class PayMultiBackendRefund extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'pay_multi_backend_refund';
    }
    ...
    {
        return [
            [['refund_id', 'refund_money', 'option_user_id', 'option_user_name', 'check_user_id', 'check_user_name', 'backend_refund_status', 'refund_status', 'pay_id', 'user_id', 'order_id', 'pay_money', 'pay_type', 'pay_status', 'pay_account', 'pay_order_id', 'order_type', 'order_state', 'requestParams', 'request_refund_params', 'create_time', 'update_time', 'is_delete'], 'required'],
            [['refund_id', 'option_user_id', 'check_user_id', 'pay_id', 'user_id', 'order_id', 'pay_type', 'pay_status', 'order_type', 'order_state', 'create_time', 'update_time', 'is_delete'], 'integer'],
