...
/* @var $model app\models\SectionQuery */
                        ...
                        <div class="panel-body">
                            <div class="col-sm-3">
                                <div class="form-group">
                                   <?= $form->field($model, 'section_name',['inputOptions' =>['class' =>'form-control','placeholder'=>""]])->textInput(['maxlength' => 20]); ?>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <?= $form->field($model, 'section_id',['inputOptions' =>['class' =>'form-control','placeholder'=>""]])->textInput(['maxlength' => 11]); ?>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <?= $form->field($model, 'parent_id',['inputOptions' =>['class' =>'form-control','placeholder'=>""]])->textInput(['maxlength' => 11]); ?>
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="form-group">
