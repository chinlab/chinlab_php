...
/* @var $model app\models\VersionQuery */
                        ...
                        <div class="panel-body">
                            <div class="col-sm-3">
                                <div class="form-group">
                                   <?= $form->field($model, 'version_name',['inputOptions' =>['class' =>'form-control','placeholder'=>"资讯标题"]])->textInput(['maxlength' => 20]); ?>
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="form-group">
                                	<?= $form->field($model, 'version_device')->dropDownList(['android'=>'安卓设备','ios'=>'苹果设备'],['prompt'=>'请选择','class' =>'form-control']); ?>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                   <?= $form->field($model, 'version_time',['inputOptions' =>['class' =>'form-control','placeholder'=>""]])->textInput(['maxlength' => 20]); ?>
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="form-group">
