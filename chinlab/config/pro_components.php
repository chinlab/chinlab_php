...
return [
    'rongyun' => [
        ...
        'appKey' => 'pgyu6atqp9f5u',
        'appSecret' => '7WVmpw1iWQr',
        'jsonPath' => 'jsonsource/',
    ],
    'sphinx' => [
        'class' => 'yii\sphinx\Connection',
        'dsn' => 'mysql:host=10.27.199.150;port=9306;',
        'username' => '',
        'password' => '',
    ],
    'queue' => [
    ...
    'db' => [
        ...
        'masters' => [
            ['dsn' => 'mysql:host=100.115.1.3;dbname=db_doctor'],
        ],
        'slaveConfig' => [
            'username' => 'php4doctor',
            'password' => 'php4nuochunfeng',
        ...
        'slaves' => [
            ['dsn' => 'mysql:host=100.115.1.4;dbname=db_doctor'],
        ],
    ],
	'db_master_one' => [
			'class' => 'yii\db\Connection',
			...
			'masters' => [
					['dsn' => 'mysql:host=10.27.199.71;dbname=db_doctor'],
			],
			'slaveConfig' => [
					'username' => 'php4doctor',
					'password' => 'php4nuochunfeng',
	...
	'db_master_two' => [
			...
			'masters' => [
					['dsn' => 'mysql:host=10.26.70.32;dbname=db_doctor'],
			],
			'slaveConfig' => [
					'username' => 'php4doctor',
					'password' => 'php4nuochunfeng',
    ...
    'runData' => [
        ...
        'baseUrl' => 'https://mainapp.huobanys.com',
    ],
    'getParams' => [
    ...
    'alipay' => [
        ...
        'notifyUrl' => 'https://mainapp.huobanys.com/alipay_pay.asp',
    ...
    'weipay' => [
        ...
        'config' => [
            ...
            'NOTIFY_URL' => 'https://mainapp.huobanys.com/userApi/pay_weipay.php',
        ],
    ],
	'unionPay' => [
		...
		'requestUrl'=>[
			...
			'SDK_FRONT_NOTIFY_URL'=> 'https://mainapp.huobanys.com/userApi/pay_unionpay.php',//前台通知地址 (商户自行配置通知地址)
			'SDK_FRONT_TRANS_URL' => 'https://mainapp.huobanys.com/userApi/pay_unionpay.php',//后台通知地址 (商户自行配置通知地址，需配置外网能访问的地址)
		],
		'proxy' => [
			'PROXY' => '10.26.118.152',
			'PROXYPORT' => '3128',
